            ...
            <form action="./registro_vista.php" method="post">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nombre" id="nombre" name="nombre" value="<?= (!empty($_POST['nombre'])) ? $_POST['nombre'] : ''; ?>" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text bg-light border-0"><i class="bi bi-person-fill"></i></span>
                        <input type="text" class="form-control" placeholder="Apellido" id="apellido" name="apellido" value="<?= (!empty($_POST['apellido'])) ? $_POST['apellido'] : ''; ?>" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" class="form-control" placeholder="Email" id="email" name="email" value="<?= (!empty($_POST['email'])) ? $_POST['email'] : ''; ?>" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" placeholder="Password" id="pass" name="pass" value="<?= (!empty($_POST['pass'])) ? $_POST['pass'] : ''; ?>" required>
                    </div>
                </div>
